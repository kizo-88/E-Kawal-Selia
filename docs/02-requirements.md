...
| Q14 | **LPKmn's official support email, phone and website.** A support address `kawalselia@lpktg.gov.my` is currently hard-coded on the login, privacy and help pages. It appears in no tender document and the domain does not match LPKmn (Kemaman). Settings are seeded empty rather than guessed. | Unit IT | GP-08; a wrong address on a public government login page |
