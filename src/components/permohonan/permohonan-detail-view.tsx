...
export interface StageLogEntryItem {
  id: string
  stageCode: string
  stageNameMs: string
  stageNameEn: string
...
export interface ApplicationDetailViewData {
  id: string
  referenceNo: string
  typeCode: string
  typeNameMs: string
  ...
  stageLogs: StageLogEntryItem[]
}

interface ApplicationDetailViewProps {
  initialData: ApplicationDetailViewData
}

export function ApplicationDetailView({ initialData }: ApplicationDetailViewProps) {
  const [data] = useState<ApplicationDetailViewData>(initialData)
  ...
  const getStatusVariant = (status: ApplicationDetailViewData['currentStatus']) => {
    switch (status) {
      case 'approved':
        return 'approved'
      case 'in_review':
