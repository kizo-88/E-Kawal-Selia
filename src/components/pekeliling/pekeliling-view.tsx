...
import { downloadCircular } from '../../app/(admin)/pekeliling/actions'
...
interface PekelilingViewProps {
  initialCirculars: CircularItem[]
}

export function PekelilingView({ initialCirculars }: PekelilingViewProps) {
  const [searchTerm, setSearchTerm] = useState('')
  const [circulars] = useState<CircularItem[]>(initialCirculars)
  ...
  const filteredCirculars = circulars.filter((c) => {
    ...
    return (
      c.titleMs.toLowerCase().includes(term) ||
